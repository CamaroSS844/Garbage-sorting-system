...
class ModelTesterApp:
    ...
    def capture_loop(self):
        ...
        if src=="webcam":
            cap=cv2.VideoCapture(int(val) if val else 0,cv2.CAP_DSHOW)
        elif src=="ipcam":
            cap=cv2.VideoCapture(val,cv2.CAP_FFMPEG)
        elif src=="video":
    ...
    def inference_loop(self):
        ...
        while self.running:
            ...
            self.display_queue.put((frame,len(dets)))
    # =====================================================
    # DISPLAY LOOP
    # =====================================================
    def update_display(self):
        ...
        if hasattr(self,"display_queue") and not self.display_queue.empty():
            ...
            frame,count=self.display_queue.get()
